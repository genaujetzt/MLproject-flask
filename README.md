# MLproject-flask
<h2>User manual</h2>
[I'm an inline-style link](https://www.google.com) [http://tracytheplane.pythonanywhere.com/] is a web application that predicts the width and depth of a welding joint based on 4 key values (IW, IF, VW, FP). To get your prediction, write your values in the corresponding boxes and press “submit”. The values must be positive. This model gives accurate predictions for IW between 43 and 49, IF between 131 and 150, VW between 4.5 and 12, FP between 50 and 125.
